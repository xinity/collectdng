...
=item B<VariablesStats> I<true|false>
 
 Enable the collection of several mysql environment variables, 
 these variables become handy while monitoring your mysql server,
 No privileges needed to 'SHOW VARIABLES' 
